...
class EmployeeRegistrationForm(UserCreationForm):
    #resumes = forms.ImageField(label='resumes', required=False)
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['resumes'].label = "resumes"
        self.fields['tel'].label = 'Tel'
    ...
    class Meta:
        model = User
        fields = ['first_name', 'last_name', 'resumes', 'tel',  'email', 'password1', 'password2', 'gender']
        error_messages = {
            'first_name': {
